...
namespace InterView_Task.Migrations
{
    ...
    [Migration("20250503113532_update6")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InterView_Task.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("InterView_Task.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("InterView_Task.Models.Product", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InterView_Task.Models.Warehouse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InterView_Task.Models.WarehouseStock", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InterView_Task.Models.InventoryTransactions", b =>
                {
                    b.HasOne("InterView_Task.Models.Warehouse", "Destination")
                        .WithMany("DestinationTransactions")
                        .HasForeignKey("DestinationId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("InterView_Task.Models.Product", "Product")
                        .WithMany("Transactions")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InterView_Task.Models.Warehouse", "Source")
                        .WithMany("SourceTransactions")
                        .HasForeignKey("SourceId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("InterView_Task.Models.ApplicationUser", "User")
                        .WithMany("Transactions")
            ...
            modelBuilder.Entity("InterView_Task.Models.WarehouseStock", b =>
                {
                    ...
                    b.HasOne("InterView_Task.Models.Warehouse", "Warehouse")
                        .WithMany("WarehouseStocks")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("InterView_Task.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InterView_Task.Models.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
